                  ...
                  {filteredSuggestions.map((suggestion) => (
                    <div key={suggestion.product_id} className="suggestion" onClick={() => { handleSelectSuggestion(suggestion) }} >
                      ...
                      <div className="product-pricing">
                        ...
                        <div className="icon">
                          <img className="medicine-icon" alt="Line arrow chevron" src={suggestion.category_outline_url ? "/cloudfront-cdn/categories/" + suggestion.category_outline_url : "/medicine-icon.svg"} fetchPriority="high" />
                        </div>
                      </div>
                    </div>
                  ))}
