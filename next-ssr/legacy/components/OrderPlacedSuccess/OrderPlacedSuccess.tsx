...
import { placePrescription, getCartDataForID } from "@/lib/api";
import {
  MdCheckCircle,
  MdLocationOn,
  MdHome,
...
export const OrderPlacedSuccess = () => {
  ...
  const [backendCartData, setBackendCartData] = useState<any>(null);
  ...
  useEffect(() => {
    ...
    const fetchPrescription = async () => {
      ...
      try {
        const response = await placePrescription(prescription_id, cart_id || 0);
