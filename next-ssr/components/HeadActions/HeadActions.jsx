...
import "./style.css";
import { useCart, useProfile } from "@/legacy/api/stateContext";
import { getUser, getDefaultAddress } from "@/legacy/api/Api";
              ...
              src={
                profileData.profilePicture
                  ? (profileData.profilePicture.startsWith("https") || profileData.profilePicture.startsWith("data:image"))
                    ? profileData.profilePicture
                    : `/cloudfront-cdn/profilepic/${profileData.profilePicture}`
                  : "/profile.svg"
              }
