            ...
            <div className="mobile-profile-container">
              ...
              <div className="mobile-profile-card">
                ...
                <div className="mobile-user-info">
                  ...
                  <Link to="/personal-info" className="mobile-update-email-link">
              ...
              <div className="mobile-profile-menu">
                <Link to="/personal-info" className="mobile-menu-item">
                ...
                <Link to="/change-password" className="mobile-menu-item">
                  <div className="mobile-menu-left">
                    <div className="mobile-menu-icon-wrapper">
                      <FiLock size={18} />
                    </div>
                ...
                <Link to="/savedaddress" className="mobile-menu-item">
                  <div className="mobile-menu-left">
                    <div className="mobile-menu-icon-wrapper">
                      <FiMapPin size={18} />
                    </div>
                ...
                <Link to="/upload-prescription" state={{ parent: 'profile' }} className="mobile-menu-item">
                  <div className="mobile-menu-left">
                    <div className="mobile-menu-icon-wrapper">
                      <FiFileText size={18} />
                    </div>
              ...
              <div className="mobile-profile-footer">
                <Link to="/policies-terms-and-conditions" className="mobile-footer-tc">
                  Terms & Conditions
                </Link>
          ...
          <div className="profile-main-layout">
            ...
            <main className="profile-content-area">
              ...
              <div className="mobile-only-links">
                <Link to="/savedaddress" className="mobile-link-item">
                  <FiMapPin className="link-icon" />
                  Manage Addresses
                </Link>
                <Link to="/upload-prescription" state={{ parent: 'profile' }} className="mobile-link-item">
